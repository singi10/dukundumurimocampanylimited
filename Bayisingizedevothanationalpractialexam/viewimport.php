<?php
    ...
    $sql = mysqli_query($conn,"SELECT * FROM import INNER JOIN foods ON import.foodid = foods.foodid ");
    $tbody = '';
    if ($sql == true) {
        $a = 0;
        ...
        if ($num_rows >0) {
            ...
            $tbody .=' <tr>
                        ...
                        <td><a href="./export.php?id='.$fetch['foodid'].'">Export</a></td>
                    </tr>';
            }
        }else {
...
<body>
        <header>
            ...
            <div class="links">
                ...
                <a href="./viewimport.php" class="index">Import</a>
